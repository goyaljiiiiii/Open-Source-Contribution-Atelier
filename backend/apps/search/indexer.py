import logging
from .tasks import index_model_for_search, remove_model_from_search, reconcile_search_index
from .utils import sanitize_index_text

logger = logging.getLogger(__name__)


def sanitize_index_payload(title: str, body_text: str = "", description: str = "", tags: str = "") -> dict:
    """
