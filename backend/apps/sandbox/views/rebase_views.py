...
SCENARIOS = [
    {
        ...
        "base_branch": "main",
        "initial_commits": [
            {"hash": "a1b2c3d", "message": "feat: add user authentication form", "author": "contributor", "files_changed": ["src/auth.ts"]},
            {"hash": "e4f5g6h", "message": "wip fix typo in auth", "author": "contributor", "files_changed": ["src/auth.ts"]},
            {"hash": "i7j8k9l", "message": "wip add validation regex", "author": "contributor", "files_changed": ["src/auth.ts"]},
            {"hash": "m0n1o2p", "message": "wip update styles", "author": "contributor", "files_changed": ["src/styles.css"]},
            {"hash": "q3r4s5t", "message": "wip cleanup console.log", "author": "contributor", "files_changed": ["src/auth.ts"]},
        ]
    },
    {
        "id": "reword-and-clean",
        ...
        "base_branch": "main",
        "initial_commits": [
            {"hash": "b8c9d0e", "message": "add stuff", "author": "contributor", "files_changed": ["src/api.ts"]},
            {"hash": "f1g2h3i", "message": "TEMP: debug print statements", "author": "contributor", "files_changed": ["src/api.ts"]},
            {"hash": "j4k5l6m", "message": "feat: connect websocket client", "author": "contributor", "files_changed": ["src/ws.ts"]},
        ]
    },
    {
        ...
        "base_branch": "main",
        "initial_commits": [
            {"hash": "c1d2e3f", "message": "feat: custom settings configuration", "author": "contributor", "files_changed": ["config/settings.py"]},
            {"hash": "g4h5i6j", "message": "conflict: update database lock timeout", "author": "contributor", "files_changed": ["config/settings.py"]},
        ]
    }
]
