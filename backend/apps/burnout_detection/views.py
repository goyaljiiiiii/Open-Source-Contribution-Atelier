...
class UserWeeklyBurnoutTrendsView(generics.GenericAPIView):
    ...
    def get(self, request):
        ...
        from .models import BurnoutActivityDay, BurnoutSignal, ContributorActivity

        User = get_user_model()
        target_user = request.user

        # Support staff inspecting another user's trend
        ...
        # Parse requested weeks (1 to 52, default 8)
        try:
        ...
        for i in range(weeks_count - 1, -1, -1):
            ...
            # Query activity days in this 7-day interval
            ...
            # Query signals in this interval
            ...
            # Compute normalized burnout score (0 - 100)
            # High active daily hours (>5h/day) + signals + high workload increase burnout
            score = 0.0
            ...
            if active_days >= 7:  # Working every single day with no rest
                score += 30.0
            elif active_days >= 6:
                score += 15.0
