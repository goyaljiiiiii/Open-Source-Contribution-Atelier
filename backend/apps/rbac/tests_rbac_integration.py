...
class RBACIntegrationTests(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.moderator_user = User.objects.create_user(username="mod", password="password")
        cls.contributor_user = User.objects.create_user(username="contrib", password="password")
        cls.student_user = User.objects.create_user(username="student", password="password")
