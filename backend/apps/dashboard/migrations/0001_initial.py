...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'status'], name='idx_pr_user_status'), models.Index(fields=['issue', 'status'], name='idx_pr_issue_status'), models.Index(fields=['status', '-created_at'], name='idx_pr_status_time')],
            },
        ),
        migrations.AddIndex(
            model_name='issue',
