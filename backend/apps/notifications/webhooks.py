...
def dispatch_outgoing_webhook(url: str, payload: dict, secret: str, attempt_number: int = 1):
    """
    ...
    try:
        ...
        logger.error(f"[WEBHOOK ATTEMPT {attempt_number} FAILED] Destination: {url} | Error: {str(e)}")
        raise e
