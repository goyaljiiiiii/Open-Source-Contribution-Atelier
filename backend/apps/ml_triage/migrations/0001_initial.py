            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ml_triage_i_reposit_0ff444_idx",
                    ),
                    models.Index(
                        fields=["priority_score"], name="ml_triage_i_priorit_2bbb3d_idx"
                    ),
                    models.Index(
                        fields=["predicted_category"],
                        name="ml_triage_i_predict_9b6244_idx",
                    ),
                    models.Index(
                        fields=["created_at"], name="ml_triage_i_created_35b301_idx"
                    ),
                ],
            },
        ),
