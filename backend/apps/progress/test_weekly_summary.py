...
def test_send_weekly_progress_summary_active_user(
    ...
    # async_task passes the payload as a positional argument (2nd arg)
    ...
    # 1 manual test-badge + 1 first-lesson badge (auto-created by evaluate_achievements_task via on_commit)
