...
class BulkProgressUpdateTests(APITestCase):
    def setUp(self):
        ...
        self.lesson1 = Lesson.objects.create(slug="lesson-1", title="Lesson 1", difficulty="beginner")
        self.lesson2 = Lesson.objects.create(slug="lesson-2", title="Lesson 2", difficulty="beginner")
        self.lesson3 = Lesson.objects.create(slug="lesson-3", title="Lesson 3", difficulty="beginner")
    ...
    def test_valid_bulk_update_updates_existing_progress(self):
        ...
        LessonProgress.objects.create(user=self.user, lesson=self.lesson1, score=50, completed=False)
