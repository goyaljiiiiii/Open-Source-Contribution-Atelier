...
from apps.progress.models import CodeSubmission, HelpRequest
...
class TestCommunityFeedTruncation:
    ...
    def setup_fixtures(self):
        ...
        self.user = User.objects.create_user(
            username="feeduser", password="password", is_active=True
        )
    ...
    def test_full_description_returned_by_default(self):
        ...
        HelpRequest.objects.create(
            user=self.user, lesson=self.lesson, message=long_message
        )
    ...
    def test_max_length_param_short_description_not_truncated(self):
        ...
        HelpRequest.objects.create(
            user=self.user, lesson=self.lesson, message=short_message
        )
