...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "xp_reward",
                    models.IntegerField(
                        default=0, help_text="Total XP earned from this path so far."
                    ),
                ),
                (
                    "priority_score",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "estimated_minutes",
                    models.PositiveIntegerField(
                        default=15, help_text="Estimated time for this step."
                    ),
                ),
                (
                    "xp_reward",
                    models.IntegerField(
                        default=10, help_text="XP awarded on step completion."
                    ),
                ),
                ...
                (
                    "reasoning",
                    models.TextField(
                        blank=True, help_text="Why the engine chose this step."
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="steps",
                        to="learning_analytics.learningpath",
                    ),
                ),
                (
                    "skill_tag",
        ...
        migrations.AddIndex(
            model_name="learningpath",
            index=models.Index(
                fields=["user", "-priority_score"], name="idx_lp_user_priority"
            ),
        ),
        migrations.AddIndex(
            model_name="learningpathstep",
            index=models.Index(
                fields=["path", "step_number"], name="idx_lps_path_step"
            ),
        ),
        migrations.AddIndex(
            model_name="learningpathstep",
