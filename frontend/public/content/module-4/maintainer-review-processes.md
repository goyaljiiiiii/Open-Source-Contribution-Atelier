...
- **Changes Requested**: The maintainer identified issues, design bugs, or missing tests. You *must* update your code before merging.
...
3. **Commit to the Same Branch**: You do *not* need to open a new PR to apply requested changes. Simply commit and push to your feature branch, and the PR will automatically update!
