...
export const ArchitectureViewer: React.FC<ArchitectureViewerProps> = ({
  ...
  const ViewerContent = () => (
    <div
      className={`relative flex flex-col bg-[#0d0f17] border border-gray-800 shadow-xl overflow-hidden group ${isFullscreen ? "w-full h-full rounded-none" : "w-full h-[500px] rounded-2xl my-4"}`}
    >
      <TransformWrapper
        initialScale={1}
        minScale={0.1}
          ...
          <>
            ...
            <div className="absolute top-4 right-4 z-10 flex gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
              <div className="flex bg-[#131622] rounded-lg border border-gray-700 shadow-lg overflow-hidden">
                ...
                <button
                  onClick={() => zoomOut()}
                  className="p-2 text-gray-400 hover:text-white hover:bg-gray-800 transition-colors border-l border-gray-700"
                  title="Zoom Out"
                >
              ...
              <div className="flex bg-[#131622] rounded-lg border border-gray-700 shadow-lg overflow-hidden">
                <button
                  ...
                  title="Export SVG"
                >
                  <span className="text-[10px] font-bold px-1 uppercase tracking-wider">
                    SVG
                  </span>
                </button>
                <button
              ...
              <button
                ...
                className="p-2 bg-[#131622] text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg border border-gray-700 shadow-lg transition-colors"
              >
                {isFullscreen ? (
                  <X className="w-4 h-4" />
                ) : (
